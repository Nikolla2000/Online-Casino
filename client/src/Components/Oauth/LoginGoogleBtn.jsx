...
const LoginGoogleBtn = () => {
  ...
  return (
    <div className='oauth-wrapper'>
      {/* <h2 className='oauth-title'>Log in with Google</h2> */}
      <div className="oauth-button-container">
        <button className="oauth-button google-button" onClick={handleClick}>
          ...
          <span className="oauth-button-text">Log in with Google</span>
        </button>
      </div>
    </div>
  )
